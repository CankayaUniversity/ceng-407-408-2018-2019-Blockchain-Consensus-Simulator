...
public class Blockchain<T extends Tx> {
	...
	public Blockchain() {
		// create genesis block genesis block means source block the all block starts this block
		chain.add(newBlock());
	}
	...
	public void addAndValidateBlock(Block<T> block) {
		...
		for (int i = chain.size() - 1; i >= 0; i--) {
			...
			System.out.print("\nPrevious Block Hash:");
			System.out.print(current.getPreviousHash());
			System.out.print("\nNext Block Hash:");
			System.out.print(b.getHash());
		...
		System.out.print("\nCompare previous block hash:Block is Valid!\n");
	...
	public Blockchain<T> add(T item) {
